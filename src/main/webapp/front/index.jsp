...
<html>
	...
	<style type="text/css">
		...
		#header .navs {
			...
			box-sizing: border-box;
			height: 80px;
			background: rgba(132,117,78, 1);
			box-shadow: 0px 0px 0px 0px rgba(162,21,43,1);
		...
		#header .navs li {
			...
			background-color: rgba(209, 31, 55, 1);
			box-shadow: 0px 0px 0px 0px rgba(162,21,43,1);
			text-align: center;
			box-sizing: border-box;
			cursor: pointer;
		...
		#header .navs li:hover {
			...
			border-color: rgba(255, 255, 255, 1);
			background-color: rgba(209, 31, 55, 1);
			box-shadow: 0px 35px 2px 0px rgba(209,31,55,1);
		}
	</style>
	<body>
		...
		<div id="tabbar" v-if="true" class="tabbar" :style='{"padding":"5px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"5px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#000","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' style="position: relative;">
		  ...
		  <div style='box-sizing: border-box;' :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"20px","fontSize":"14px","borderStyle":"solid"}' class="company"></div>
		  <div style='box-sizing: border-box;' :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"30px","fontSize":"14px","borderStyle":"solid"}' class="record">Welcome</div>
		  <div style='box-sizing: border-box;' :style='{"padding":"0","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"5px auto","borderColor":"rgba(255,255,255,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"1px","width":"50%","lineHeight":"20px","fontSize":"14px","borderStyle":"solid"}' class="desc"></div>
		</div>
