			...
			<div class="center-container">
				...
				<div class="right-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px rgba(132, 117, 78, 1)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">问题一</label>
							<div class="layui-input-block input">
								<input type="text"  name="wentiyi" name="wentiyi" id="wentiyi" placeholder="问题一" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">回答一</label>
							<div class="layui-input-block input">
								<input type="text"  name="huidayi" name="huidayi" id="huidayi" placeholder="回答一" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">问题二</label>
							<div class="layui-input-block input">
								<input type="text"  name="wentier" name="wentier" id="wentier" placeholder="问题二" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">回答二</label>
							<div class="layui-input-block input">
								<input type="text"  name="huidaer" name="huidaer" id="huidaer" placeholder="回答二" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">问题三</label>
							<div class="layui-input-block input">
								<input type="text"  name="wentisan" name="wentisan" id="wentisan" placeholder="问题三" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">回答三</label>
							<div class="layui-input-block input">
								<input type="text"  name="huidasan" name="huidasan" id="huidasan" placeholder="回答三" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">问题四</label>
							<div class="layui-input-block input">
								<input type="text"  name="wentisi" name="wentisi" id="wentisi" placeholder="问题四" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">回答四</label>
							<div class="layui-input-block input">
								<input type="text"  name="huidasi" name="huidasi" id="huidasi" placeholder="回答四" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">答卷时间</label>
							<div class="layui-input-block date">
								<input type="text" name="dajuanshijian" id="dajuanshijian" placeholder="答卷时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">学生姓名</label>
							<div class="layui-input-block input">
