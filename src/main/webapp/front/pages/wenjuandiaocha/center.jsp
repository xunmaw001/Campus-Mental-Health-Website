					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							...
							<div class="layui-input-block">
								<img id="tupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :style='{"boxShadow":"0 0 6px rgba(132, 117, 78,.8)","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"2px","width":"80px","borderStyle":"solid","height":"80px"}' src="../../img/avator.png">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							...
							<div class="layui-input-block">
								<button :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(132, 117, 78,.5)","margin":"0 10px 0 0","borderColor":"#ccc","backgroundColor":"rgba(132, 117, 78, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="button" class="layui-btn btn-theme" id="tupianUpload">
