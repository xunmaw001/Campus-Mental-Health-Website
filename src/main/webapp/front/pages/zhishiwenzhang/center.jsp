				...
				<div class="right-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px rgba(132, 117, 78, 1)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">文章标题</label>
							<div class="layui-input-block input">
								<input type="text"  name="wenzhangbiaoti" name="wenzhangbiaoti" id="wenzhangbiaoti" placeholder="文章标题" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">文章类型</label>
							<div class="layui-input-block select">
								<select name="wenzhangleixing" id="wenzhangleixing" >
									<option value="">请选择</option>
									<option v-for="(item,index) in wenzhangleixing" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(132, 117, 78, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2px 0","borderStyle":"solid"}'>
