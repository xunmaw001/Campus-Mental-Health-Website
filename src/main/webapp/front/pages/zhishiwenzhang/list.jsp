...
<html>
	...
	<body>
			...
			<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 6px rgba(132, 117, 78,.8)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","background":"rgba(255,255,255,1)","borderStyle":"solid"}'>
				<div class="box" style='width:80%'>
					...
					<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(132, 117, 78,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(202, 39, 58, 1)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
						...
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"#fff","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>文章标题</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"#ccc","backgroundColor":"#fff","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"0","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="wenzhangbiaoti" id="wenzhangbiaoti" placeholder="文章标题" autocomplete="off" class="layui-input">
						</div>
		...
		<div v-if="1 == 1" style="position: absolute;left: 0;top: 0;transform: translate3d(-100%, 0, 0);" :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0px 0px 0 -30px","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"84px","borderStyle":"solid","height":"auto"}'>
	    		<div style="text-align: center;cursor: pointer;" class="category-search" :index="-1" :style='swiperIndex==-1?{"padding":"0 10px","boxShadow":"0 0 6px rgba(132, 117, 78,.3)","margin":"4px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(132, 117, 78, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}:{"padding":"0 10px","boxShadow":"0 0 6px rgba(132, 117, 78,.3)","margin":"4px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"#fff","color":"#333","borderRadius":"4px","borderWidth":"0","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}'>全部</div>
			<div v-for="(item,index) in categoryList" :key="index" >
				<div style="text-align: center;cursor: pointer;" :style='swiperIndex==index?{"padding":"0 10px","boxShadow":"0 0 6px rgba(132, 117, 78,.3)","margin":"4px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(132, 117, 78, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}:{"padding":"0 10px","boxShadow":"0 0 6px rgba(132, 117, 78,.3)","margin":"4px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"#fff","color":"#333","borderRadius":"4px","borderWidth":"0","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' :index="index" class="category-search">{{categoryList[index]}}</div>
			</div>
		</div>
							<div @click="jump('../zhishiwenzhang/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="3=='3'?'list-item3':3=='5'?'list-item5':''">
								<div class="list-item-body animation-box" :style='{"padding":"10px","boxShadow":"0 0 6px rgba(132, 117, 78,.8)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
									<img :style='{"boxShadow":"0 0 6px rgba(132, 117, 78,.8)","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"300px","borderStyle":"solid","height":"200px"}' :src="item.tupian?baseurl+item.tupian.split(',')[0]:''">
									<div class="info">
										...
										<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(34, 2, 2, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"14px"}' class="name">{{item.wenzhangbiaoti}}</div>
									</div>
								</div>
							</div>
						</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate'], function() {
				...
				http.request('config/list', 'get', {
        			...
        			http.request(`option/wenzhangleixing/wenzhangleixing`,'get',{},(res)=>{
                			vue.wenzhangleixingOptions = res.data
        			});
				...
				//类型搜索
				  ...
				  // 获取列表数据
				  http.request('option/wenzhangleixing/wenzhangleixing', 'get', {}, function(res) {
				...
				if(vCategory!='' && category!='全部') {
					param['wenzhangleixing'] = category;
				}
				...
				if (jquery('#wenzhangbiaoti').val()) {
					...
					// 获取列表数据
					http.request('zhishiwenzhang/list', 'get', param, function(res) {
