				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.wenzhangbiaoti" type="text" :readonly="ro.wenzhangbiaoti" name="wenzhangbiaoti" id="wenzhangbiaoti" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		                <label class="layui-form-label">文章类型</label>
		                <div class="layui-input-block">
		                    <select name="wenzhangleixing" id="wenzhangleixing" lay-filter="wenzhangleixing"  >
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        if(o=='wenzhangbiaoti'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.wenzhangbiaoti = true;
                                                continue;
                                        }
                                        if(o=='wenzhangleixing'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.wenzhangleixing = true;
                                                continue;
                                        }
                                        if(o=='tupian'){
                                                vue.detail[o] = obj[o];
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('zhishiwenzhang/list', 'get', {
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('zhishiwenzhang' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
