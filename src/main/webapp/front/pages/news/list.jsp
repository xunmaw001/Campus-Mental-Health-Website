...
<html>
	...
	<body>
		...
		<div id="app">
			<!-- 轮播图 -->
			<div class="layui-carousel" id="test1" :style='{"boxShadow":"0 0 0px rgba(110,22,64,0.8)","margin":"0 auto","borderColor":"rgba(0, 0, 0, 1)","borderRadius":"0px","borderWidth":"0px","width":"91%","borderStyle":"solid"}'>
			  <div carousel-item>
			...
			<!-- 标题 -->
			<div class="index-title" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(0, 0, 0, 1)","borderRadius":"0px","alignItems":"center","borderWidth":"0px","fontSize":"16px","borderStyle":"solid"}'>
			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 6px rgba(132, 117, 78,.8)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","background":"rgba(255,255,255,1)","borderStyle":"solid"}'>
					...
					<div class="list">
						<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" class="list-item" :class="3=='3'?'list-item3':3=='5'?'list-item5':''">
							<div class="list-item-body animation-box" :style='{"padding":"10px","boxShadow":"0 0 6px rgba(132, 117, 78,.8)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
								<img :style='{"boxShadow":"0 0 6px rgba(132, 117, 78,.8)","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"300px","borderStyle":"solid","height":"200px"}' :src="baseurl+item.picture">
								<div class="info">
									<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(19, 3, 3, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"14px"}' class="name">{{item.title}}</div>
								</div>
							</div>
						</div>
					</div>
