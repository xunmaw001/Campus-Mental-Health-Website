...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>文章类型管理</span></li>
								<li class="breadcrumb-item active"><span>文章类型列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="wenzhangleixingSearch" class="form-control form-control-sm" placeholder="请输入文章类型" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('wenzhangleixing')">文章类型<i id="wenzhangleixingIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#wenzhangleixingSearch').val() != null && $('#wenzhangleixingSearch').val() != ''){
				searchForm.wenzhangleixing ="%" +  $('#wenzhangleixingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("wenzhangleixing/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				wenzhangleixing : searchForm.wenzhangleixing,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var wenzhangleixingCell  = document.createElement('td');

						 wenzhangleixingCell.innerHTML = item.wenzhangleixing;

			row.appendChild(wenzhangleixingCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("wenzhangleixing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function getSum(colName){
		http("wenzhangleixing"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"wenzhangleixing");
