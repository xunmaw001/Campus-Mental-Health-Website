		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑情况反馈</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>情况反馈管理</span></li>
								<li class="breadcrumb-item active"><span>编辑情况反馈</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">情况反馈信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>电话</label>
										<input id="dianhua" name="dianhua" class="form-control"  value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>反馈时间</label>
	...
	<script>
		...
		function gonghaoSelect2Change(){
			...
			http("follow/jiaoshi/gonghao","GET",{
				...
				if(res.code == 0){
					...
					if(res.data != null && res.data.dianhua != null){
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "qingkuangfankui/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("qingkuangfankui/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("qingkuangfankui/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("qingkuangfankui/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("qingkuangfankui"+colName,"GET",{
