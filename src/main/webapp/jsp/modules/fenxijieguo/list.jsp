...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">分析结果管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>分析结果列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">分析结果列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="dengji" id="dengjiSelect" class="form-control form-control-sm" aria-controls="tableId">
										...
										<option value="不良状态">不良状态</option>
										<option value="心理障碍">心理障碍</option>
										<option value="心里疾病">心里疾病</option>
									</select>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var fenxiCell  = document.createElement('td');

						  if(item.fenxi != null && item.fenxi != "" && item.fenxi.length >= 11){
			  	fenxiCell.innerHTML = item.fenxi.substring(0, 10) + "..."; 
			  }else{
			  	fenxiCell.innerHTML = item.fenxi;
			  }


			row.appendChild(fenxiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("fenxijieguo/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"fenxijieguo");
